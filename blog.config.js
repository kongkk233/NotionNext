...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'wizard', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '计算机科班出身，在计算机学院，但是在做卫星网络...', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.wizardkong.top/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '杂记, 博客, 提升', // 网站关键词 英文逗号隔开
